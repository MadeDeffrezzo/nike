...
<body>
    <header>
        ...
        <div class="header_bottom1">
            <div class="hb">
                <img src="../../img/logo.png" alt="" class="img4">
                <h1>О нас</h1>
            </div>
            <div class="hb">
                <img src="../../img/Group 43.png" alt="" class="img5">
            </div>
        </div>
    ...
    <main>
        <section id="onas">
            ...
            <div class="onas">
                <div class="mxw1400">
                    <h2>Как появилась фирма Найк?</h2>
                    <p>В 1962 году Фил занял немного денег у своего отца и отправился в Японию, где закупил пробную
                        партию этих кроссовок. Во время переговоров с японцами, ему пришлось на ходу придумать название
                        компании, которую он представляет - Blue Ribbon Sports. Так и появилось первое название будущего
                        гиганта Nike.</p>
                </div>
            </div>
